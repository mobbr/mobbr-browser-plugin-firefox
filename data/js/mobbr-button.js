...
var mobbr = mobbr || (function () {
        ...
        function createMobbrDiv() {
            ...
            if (!mobbrDiv) {
                ...
                a.style.cssText = 'cursor: pointer; font-size: 26px; font-family: sans-serif; text-align: center; line-height: 59px; position:absolute; top:0; right:0; text-decoration:none; width: 60px; height: 59px; color: #595f64; z-index: 99999999999; border-left: 1px solid #000; border-bottom: 1px solid #000;';
                a.onclick = hide;
                a.innerHTML = 'x';
